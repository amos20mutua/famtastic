...
export function WelcomePage() {
  ...
  return (
    <div className="min-h-screen bg-glow px-4 py-3.5 sm:py-6 md:px-6 md:py-8">
      <div className="mx-auto flex min-h-[calc(100svh-2rem)] max-w-6xl flex-col gap-3 sm:gap-5 md:justify-center lg:flex-row">
        <Panel className="px-4 py-6 sm:px-6 sm:py-8 md:px-9 md:py-10 lg:flex-1">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <h1 className="max-w-2xl text-balance font-display text-[2.15rem] font-semibold leading-[0.98] tracking-[-0.03em] text-slatewarm-900 sm:text-[3.1rem] md:text-[3.9rem]">
        ...
        <Card className="flex w-full flex-col justify-between gap-4 px-4 py-5 sm:px-6 sm:py-7 md:px-7 lg:max-w-[398px]">
          <div className="space-y-4">
